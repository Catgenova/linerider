namespace NeonLineRider.Core
{
    ...
    public static class Riders
    {
        ...
        {
            new RiderDef { Id = "bosh", Name = "Bosh", Tagline = "The original", Description = "Classic sled physics. Balanced weight, honest momentum, breaks like you remember.", Color = "#39f6ff", Glow = "#00c8ff", Model = RiderModel.Sled },
            ...
            new RiderDef { Id = "nova", Name = "Nova", Tagline = "Boarder", Description = "Rides a board instead of a sled. Longer contact patch, higher centre of mass: stable on rails, wild in the air.", Color = "#ff2bd6", Glow = "#ff00c8", Model = RiderModel.Board, FrictionScale = 0.7, EnduranceScale = 1.25, Unlock = "roof-2" },
        };
