...
namespace NeonLineRider.Core
{
    ...
    public static class Materials
    {
        public static readonly Material[] All =
        {
            ...
            new Material { Id = MaterialId.Sticky, Key = "sticky", Name = "Sticky", Color = "#c65cff", Glow = "#9b1cff", Cost = 1.5, Solid = true, FrictionScale = 6, Stickiness = 0.35, Hotkey = "7", Description = "Grabs the sled. Great for killing speed before a drop." },
