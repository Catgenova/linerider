...
export const RIDERS: Record<RiderId, RiderDef> = {
  bosh: {
    ...
    description: 'The classic rig on a hoverboard. Balanced weight, honest momentum, breaks like you remember.',
    color: '#39f6ff',
    glow: '#00c8ff',
    model: SLED_MODEL,
    gravityScale: 1,
  ...
  nova: {
    ...
    name: 'Nova',
    tagline: 'Boarder',
    description: 'Rides a long deck with a tall standing rig. Longer contact patch, higher centre of mass: stable on rails, wild in the air.',
    color: '#ff2bd6',
    glow: '#ff00c8',
    model: BOARD_MODEL,
    gravityScale: 1,
